...
public:
	...
	static void toggleFriend(const QString& currentUsername, const QString& targetUsername); // Adds the target user to the current user's friend list if they aren't already friends.
};